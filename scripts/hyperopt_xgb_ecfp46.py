...
OUT_JSON = "reports/hyperopt_xgb_best_ecfp46.json"
...
def main():
    ...
    space = {
        "zero_thresh": hp.uniform("zero_thresh", 0.90, 0.995),
        "corr_thresh": hp.uniform("corr_thresh", 0.60, 0.95),

        "n_estimators": hp.quniform("n_estimators", 300, 1800, 1),
        "max_depth": hp.quniform("max_depth", 3, 12, 1),
        "learning_rate": hp.loguniform("learning_rate", np.log(0.004), np.log(0.12)),
    ...
    out = {
        ...
        "features": "ECFP4(2048)+ECFP6(2048)+MACCS(~167) with feature selection"
    }
